                                ...
                                <div class="mb-1">
                                    <div class="btn-toolbar justify-content-between" role="toolbar"
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <select class="form-control ml-2" style="" name="" id="bidang">
...
@push('jsScript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function loaddata(page, cari, jml, bidang) {
                $.ajax({
            ...
            function loadpage(cari, jml, bidang) {
                $.ajax({
                    url: '{{ route($title . '.data') }}',
                    data: {
                        "cari": cari,
            ...
            $("#pencarian, #jumlah,#bidang").on('keyup change', function(event) {
                let cari = $('#pencarian').val();
                let bidang = $('#bidang').val();
                let jml = $('#jumlah').val();
                loadpage(cari, jml, bidang);
            });
            // proses simpan
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(data) {
                        ...
                        $('#formInput').trigger("reset");
                        $('#ajaxModel').modal('hide');
                        toastr.warning("Failed to update data!");
                    }
                });
            });
