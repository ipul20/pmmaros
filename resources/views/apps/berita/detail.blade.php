...
@push('metaIndex')
    ...
    <meta property="og:description" content="{{ Str::limit(strip_tags($berita->deskripsi), 50) }}" />
    <meta property="og:image" itemprop="image" content="{{asset('/landing/images/berita'.'/'.$berita->thumbnail)}}" />
@endpush
@push('cssIndex')
@endpush
@section('content')
                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry entry-single pt-5">
                            ...
                            <div class="entry-img d-flex justify-content-center">
                                <img src="{{ asset('/landing/images/berita') . '/' . $berita->thumbnail }}" alt=""
